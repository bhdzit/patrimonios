...
//                      child: Image.network(widget.value.Imagen,fit:BoxFit.cover,height: 100,),
  ...
  Future<void> _launchPDF(extenso) async {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  Future<void> _launchUrl(extenso) async {
    final Uri url = Uri.parse(extenso);
